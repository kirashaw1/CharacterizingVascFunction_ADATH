...
% Figures for 2s stim mixed disease model project
...
shadedErrorBar(time, mean(hbr_W(find(T.grpID==3),:),1),...
    getSEM(hbr_W(find(T.grpID==3),:),1),'lineprops','b'); 
xlabel('Time(s)');
ylabel('Micromolar Change');
xlim([time(1) time(end)]);
plot([5 5],[-2 4],'k--');
...
load('walking_totals_n156_exp1.mat','all_walk_distance');
...
subplot(5,4,1);
hold on; 
shadedErrorBar(time,mean(locomotion(find(locoGrp==1),:),1),...
    getSEM(locomotion(find(locoGrp==1),:),1),'lineprops','k');
ylabel('AU');
xlim([time(1) time(end)]);
plot([5 5],[0 1],'k--');
plot([7 7],[0 1],'k--');
...
subplot(5,4,2);
hold on; 
shadedErrorBar(time,mean(locomotion(find(locoGrp==2),:),1),...
    getSEM(locomotion(find(locoGrp==2),:),1),'lineprops','k');
xlim([time(1) time(end)]);
plot([5 5],[0 1],'k--');
plot([7 7],[0 1],'k--');
plot([0 25],[0 0],'k--');
...
subplot(5,4,3);
hold on; 
shadedErrorBar(time,mean(locomotion(find(locoGrp==3),:),1),...
    getSEM(locomotion(find(locoGrp==3),:),1),'lineprops','k');
xlim([time(1) time(end)]);
plot([5 5],[0 1],'k--');
plot([7 7],[0 1],'k--');
plot([0 25],[0 0],'k--');
...
subplot(5,4,4);
hold on; 
shadedErrorBar(time,mean(locomotion(find(locoGrp==4),:),1),...
    getSEM(locomotion(find(locoGrp==4),:),1),'lineprops','k');
xlim([time(1) time(end)]);
plot([5 5],[0 1],'k--');
plot([7 7],[0 1],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
title('Locomotion')
plot(time, mean(locomotion(find(T.trialID<=5),:),1),'k');
plot(time, mean(locomotion(find(T.trialID>=25),:),1),'r');
legend('Early Trials','Late Trials', 'AutoUpdate', 'Off');
shadedErrorBar(time, mean(locomotion(find(T.trialID<=5),:),1),...
    getSEM(locomotion(find(T.trialID<=5),:),1),'lineprops','k');
shadedErrorBar(time, mean(locomotion(find(T.trialID>=25),:),1),...
    getSEM(locomotion(find(T.trialID>=25),:),1),'lineprops','r');
...
shadedErrorBar(time, mean(hbt_W(find(T.trialID<=5),:),1),...
    getSEM(hbt_W(find(T.trialID<=5),:),1),'lineprops','k');
shadedErrorBar(time, mean(hbt_W(find(T.trialID>=25),:),1),...
    getSEM(hbt_W(find(T.trialID>=25),:),1),'lineprops','r');
ylabel('Micromolar change'); 
xlabel('Time(s)')
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
...
subplot(4,4,1);
hold on; 
plot(time, mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),'m');
plot(time, mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),'g');
plot(time, mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),'b');
plot(time, mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),'k');
legend('Grp1','Grp2','Grp3','Grp4','AutoUpdate','Off');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID<=5),find(T.grpID==4))),:),1),...find(T.trialID<=5)
    'lineprops','k');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 1, Late Trials (25-30)');
ylabel('Locomotion (AU)'); 
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 2, Late Trials (25-30)');
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 3, Late Trials (25-30)');
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 4, Late Trials (25-30)'); 
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 1, Late Trials (25-30)');
ylabel('Micromolar change'); 
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 2, Late Trials (25-30)');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
plot([7 7],[-2 5],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 3, Late Trials (25-30)');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
plot([7 7],[-2 5],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.trialID>=25),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 4, Late Trials (25-30)');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
plot([7 7],[-2 5],'k--');
...
%% FIGURE 5 EXP ID
% Separate by exp day 1 and exp day 4 (rather than early vs late trials)
...
plot(time, mean(locomotion(find(T.expID==4),:),1),'r');
legend('Exp D1','Exp D4', 'AutoUpdate', 'Off');
shadedErrorBar(time, mean(locomotion(find(T.expID==1),:),1),...
    getSEM(locomotion(find(T.expID==1),:),1),'lineprops','k');
shadedErrorBar(time, mean(locomotion(find(T.expID==4),:),1),...
    getSEM(locomotion(find(T.expID==4),:),1),'lineprops','r');
ylabel('Locomotion (AU)'); 
xlabel('Time(s)')
xlim([time(1) time(end)]);
plot([5 5],[0 3],'k--');
...
shadedErrorBar(time, mean(hbt_W(find(T.expID==1),:),1),...
    getSEM(hbt_W(find(T.trialID<=5),:),1),'lineprops','k');
shadedErrorBar(time, mean(hbt_W(find(T.expID==4),:),1),...
    getSEM(hbt_W(find(T.trialID>=25),:),1),'lineprops','r');
ylabel('Micromolar change'); 
xlabel('Time(s)')
xlim([time(1) time(end)]);
...
% LOCOMOTION TRACES FOR EXP DAY 4
subplot(4,4,9);
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 1, Exp Day 4');
ylabel('Locomotion (AU)'); 
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 2, Exp Day 4');
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 3, Exp Day 4');
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(locomotion(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Locomotion, Loco Cond 4, Exp Day 4'); 
xlim([time(1) time(end)]);
plot([5 5],[0 10],'k--');
plot([7 7],[0 10],'k--');
plot([0 25],[0 0],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 1, Exp Day 4');
ylabel('Micromolar change'); 
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==2),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 2, Exp Day 4');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
plot([7 7],[-2 5],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==3),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 3, Exp Day 4');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
plot([7 7],[-2 5],'k--');
...
hold on; 
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==1))),:),1),...
    'lineprops','m');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==2))),:),1),...
    'lineprops','g');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==3))),:),1),...
    'lineprops','b');
shadedErrorBar(time, ...
    mean(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==4),intersect(find(T.expID==4),find(T.grpID==4))),:),1),...
    'lineprops','k');
title('Hbt Whisker, Loco Cond 4, Exp Day 4)');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-2 5],'k--');
plot([7 7],[-2 5],'k--');
...
subplot(144);
hold on; 
title('Grp 4: WT, Rest Trials Only')
...
plot(time, mean(hbt_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),'g');
plot(time, mean(hbo_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),'r');
plot(time, mean(hbr_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),'b');
legend('Hbt','HbO', 'Hbr','AutoUpdate','Off');
shadedErrorBar(time, mean(hbt_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),...
    getSEM(hbo_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),...
    getSEM(hbr_W(intersect(find(T.locoGrp==1),find(T.trialID<=5)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
...
subplot(122);
hold on; 
title('Late Trials (25-30), Rest Trials Only')
shadedErrorBar(time, mean(hbt_W(intersect(find(T.locoGrp==1),find(T.trialID>=25)),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),find(T.trialID>=25)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(find(T.locoGrp==1),find(T.trialID>=25)),:),1),...
    getSEM(hbo_W(intersect(find(T.locoGrp==1),find(T.trialID>=25)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(find(T.locoGrp==1),find(T.trialID>=25)),:),1),...
    getSEM(hbr_W(intersect(find(T.locoGrp==1),find(T.trialID>=25)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
...
subplot(122);
hold on; 
title('Exp D4, Rest Trials Only')
shadedErrorBar(time, mean(hbt_W(intersect(find(T.locoGrp==1),find(T.expID==4)),:),1),...
    getSEM(hbt_W(intersect(find(T.locoGrp==1),find(T.expID==4)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(find(T.locoGrp==1),find(T.expID==4)),:),1),...
    getSEM(hbo_W(intersect(find(T.locoGrp==1),find(T.expID==4)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(find(T.locoGrp==1),find(T.expID==4)),:),1),...
    getSEM(hbr_W(intersect(find(T.locoGrp==1),find(T.expID==4)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
...
subplot(422);
hold on; 
title('Exp D4, Rest Trials Only, Grp 1 AD')
shadedErrorBar(time, mean(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==1)),:),1),...
    getSEM(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==1)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==1)),:),1),...
    getSEM(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==1)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==1)),:),1),...
    getSEM(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==1)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
...
subplot(424);
hold on; 
title('Exp D4, Rest Trials Only, Grp 2 WT')
shadedErrorBar(time, mean(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==2)),:),1),...
    getSEM(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==2)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==2)),:),1),...
    getSEM(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==2)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==2)),:),1),...
    getSEM(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==2)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
...
subplot(426);
hold on; 
title('Exp D4, Rest Trials Only, Grp 3 ATH')
shadedErrorBar(time, mean(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==3)),:),1),...
    getSEM(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==3)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==3)),:),1),...
    getSEM(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==3)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==3)),:),1),...
    getSEM(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==3)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
...
subplot(428);
hold on; 
title('Exp D4, Rest Trials Only, Grp 4 MIX')
shadedErrorBar(time, mean(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==4)),:),1),...
    getSEM(hbt_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==4)),:),1),'lineprops','g');
shadedErrorBar(time, mean(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==4)),:),1),...
    getSEM(hbo_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==4)),:),1),'lineprops','r');
shadedErrorBar(time, mean(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==4)),:),1),...
    getSEM(hbr_W(intersect(intersect(find(T.locoGrp==1),find(T.expID==4)),find(T.grpID==4)),:),1),'lineprops','b');
xlabel('Time(s)');
xlim([time(1) time(end)]);
plot([5 5],[-1 3],'k--');
plot([7 7],[-1 3],'k--');
